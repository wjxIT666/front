        ...
        <el-table
            ...
            >
                ...
                <el-table-column
                    ...
                    <template slot="header">
                        <span>试玩成功率</span>
                        <ToolTip :ToolTipText="'=试玩成功/尝试连接设备'">
                            <i class="al-wenhao iconstyle"></i>
                        </ToolTip>
                    </template>
                </el-table-column>
...
export default {
    ...
    methods: {
        ...
        async search () {
            ...
            let data = { date: currentDate, todate: endDate, package: packageValue, os: osValue, pv: this.type };
            let DataTableH5Res = await this.$api.DataTableH5Interface(data);
        ...
        exportOrderData() {
            ...
            this.$nextTick(function () {
                ...
                try {
                    FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), '云游戏URL.xlsx')
                } catch (e) { 
