<template>
    <div class="customer_info" style="min-width: 1200px;">
        <!-- 入驻页面 -->
       <el-container>
...
export default {
                ...
                if (valid) {
                    ...
                    if (this.checked) {
                        ...
                        let data = {
                            ...
                            isAgree: 1,
                            corpId: this.baseInfoItem.Item.corpId
                        };
                        let dataParams = {
                            data: checkRSA(data)
                        };
                        let proveRes = await this.$api.updateProveInterface(dataParams);
                        if (proveRes.code === 0) {
    ...
    mounted () {
        ...
        //联系人姓名
        this.form.Name = this.baseInfoItem.Item.Name;
        //联系人手机号
        this.form.Tel = this.baseInfoItem.Item.Tel;
        //联系人邮箱
        this.form.Email = this.baseInfoItem.Item.Email;
        // console.log(this.baseInfoItem);
    }
}
</script>
